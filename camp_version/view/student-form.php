...
<body>
    ...
    <div class="container-fluid">
        ...
        <hr>
        <div class="container">
            <form action="<?php echo base_url(); ?>index.php/60160027/reg/addStudent" method="post">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="input-group mb-3">
                                ...
                                <input name="code" placeholder="กรอกรหัสประจำตัว" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-group mb-3">
                        ...
                        <div class="row">
                            <div class="input-group">
                                ...
                                <input name="fname" placeholder="ชื่อจริง" type="text" aria-label="First name" class="form-control">
                                <input name="lanme" placeholder="นามสกุล" type="text" aria-label="Last name" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="input-group mb-3">
                                ...
                                <input name="age" placeholder="กรอกอายุ" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </div>
                    </div>
                    <div class="container">
